...
class Conv1D(HyperLayer):
    def __init__(self, filters, kernel_size, strides=1, padding='valid', data_format="channels_last", space=None, name=None,
                 **kwargs):
        ...
        if data_format is not None:
            kwargs['data_format'] = data_format
        HyperLayer.__init__(self, kl.Conv1D, space, name, **kwargs)
...
class SeparableConv1D(HyperLayer):
    def __init__(self, filters, kernel_size, strides=1, padding='valid', data_format=None, space=None, name=None,
                 **kwargs):
        kwargs['filters'] = filters
        kwargs['kernel_size'] = kernel_size
        if strides is not None:
        ...
        if data_format is not None:
            kwargs['data_format'] = data_format
        HyperLayer.__init__(self, kl.SeparableConv1D, space, name, **kwargs)
...
class AveragePooling1D(HyperLayer):
    def __init__(self, pool_size=2, strides=None, padding='valid', data_format="channels_last", space=None, name=None,
                 **kwargs):
        ...
        if data_format is not None:
            kwargs['data_format'] = data_format
        HyperLayer.__init__(self, kl.AveragePooling1D, space, name, **kwargs)
...
class MaxPooling1D(HyperLayer):
    def __init__(self, pool_size=2, strides=None, padding='valid', data_format="channels_last", space=None, name=None,
        ...
        if data_format is not None:
            kwargs['data_format'] = data_format
        HyperLayer.__init__(self, kl.MaxPooling1D, space, name, **kwargs)
...
class GlobalAveragePooling1D(HyperLayer):
    def __init__(self, data_format="channels_last", space=None, name=None, **kwargs):
        if data_format is not None:
            kwargs['data_format'] = data_format
        HyperLayer.__init__(self, kl.GlobalAveragePooling1D, space, name, **kwargs)
...
class GlobalMaxPooling1D(HyperLayer):
    def __init__(self, data_format="channels_last", space=None, name=None, **kwargs):
        if data_format is not None:
            kwargs['data_format'] = data_format
        HyperLayer.__init__(self, kl.GlobalMaxPooling1D, space, name, **kwargs)
...
class LSTM(HyperLayer):
    def __init__(self, units, go_backwards=False,  return_sequences=False, data_format=None, space=None, name=None, **kwargs):
        kwargs['units'] = units
        if return_sequences is not None:
            kwargs['return_sequences'] = return_sequences
        if data_format is not None:
            kwargs['data_format'] = data_format
        if go_backwards is not None:
            kwargs['go_backwards'] = go_backwards
        HyperLayer.__init__(self, kl.LSTM, space, name, **kwargs)
        
class Masking(HyperLayer):
    def __init__(self, mask_value=-1, data_format=None, space=None, name=None, **kwargs):
...
class LayerNormalization(HyperLayer):
    def __init__(self, space=None, name=None, **kwargs):
        HyperLayer.__init__(self, kl.LayerNormalization, space, name, **kwargs)