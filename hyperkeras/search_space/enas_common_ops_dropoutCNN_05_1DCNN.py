...
def sepconv1d_bn(no, name_prefix, kernel_size, filters, strides=1, data_format=None, x=None):
...
def sepconv3x3(name_prefix, filters, strides=1, data_format=None):
    name_prefix = name_prefix + 'sepconv3x3_'
    sep1 = sepconv1d_bn(0, name_prefix, kernel_size=3, filters=filters, strides=strides, data_format=data_format)
    sep2 = sepconv1d_bn(1, name_prefix, kernel_size=3, filters=filters, strides=strides, data_format=data_format,
                        x=sep1)
    return sep2


def sepconv5x5(name_prefix, filters, strides=1, data_format=None):
    name_prefix = name_prefix + 'sepconv5x5_'
    sep1 = sepconv1d_bn(0, name_prefix, kernel_size=5, filters=filters, strides=strides, data_format=data_format)
